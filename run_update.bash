...
lat0=`gdalinfo BATNAS_115E-120E_05S-000_MSL_v1.1.tif | grep "Lower Left" | awk -F "(" '{print $2}' | awk -F ",  " '{print $2}' | sed -e 's/ //g' -e 's/)//g'`
lon0=`gdalinfo BATNAS_115E-120E_05S-000_MSL_v1.1.tif | grep "Lower Left" | awk -F "(" '{print $2}' | awk -F ",  " '{print $1}' | sed 's/ //g'`
latf=`gdalinfo BATNAS_115E-120E_05S-000_MSL_v1.1.tif | grep "Upper Right" | awk -F "(" '{print $2}' | awk -F ",  " '{print $2}' | sed -e 's/ //g' -e 's/)//g'`
lonf=`gdalinfo BATNAS_115E-120E_05S-000_MSL_v1.1.tif | grep "Upper Right" | awk -F "(" '{print $2}' | awk -F ",  " '{print $1}' | sed 's/ //g'`
